...
```{r table S1 inconsistencies and gross inconsistencies, echo = FALSE, warning = FALSE, message = FALSE, include=knitr::is_latex_output()}
...
```{r table S2 publication bias, echo = FALSE, warning = FALSE, message = FALSE, include=knitr::is_latex_output()}
#Creating content table cells.
