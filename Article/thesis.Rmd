...
h3ab_table %>%
  #booktabs used, centered alignment, caption
kable(booktabs = T, align = "c", caption = "Logistic regressions for H3a and H3b, which concerns the difference in prevalence of publication bias in results related to hypotheses versus results not related to hypotheses.") %>% 
  #grouping data for the two hypotheses
