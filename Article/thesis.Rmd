...
- \captionsetup[table]{textfont={it}, labelfont={bf}, singlelinecheck=false, labelsep=newline} #APA captions tables
- \captionsetup[figure]{textfont={it}, labelfont={bf}, singlelinecheck=false, labelsep=newline} #APA captions figures
- \usepackage{floatrow}
- \floatsetup[figure]{capposition=top} #Caption figure top.
- \floatsetup[table]{capposition=top} #Caption table top.
#- \usepackage{float} #setting in place figures and tables
...
table1 %>%
  ...
  kable(booktabs = T, align = "c", caption = "Overview of information provided by ‘AllP', ‘APA', and ‘Hyp'.", escape = FALSE) %>% #booktabs used, centered alignment, caption caption
...
table2 <- table2 %>%
  #centered alignment
  kable(booktabs = T, align = "c", caption = "Overview of numbers of statistical results and accompanying articles used in analyses of results-related topics for ‘AllP', ‘APA', and ‘Hyp'.") %>%  #booktabs used, centered alignment, caption caption
...
#Creating Table 3.
table3 %>%
  #booktabs used, centered alignment, caption caption
...
#Creating Table 6.
table6 %>%
  #format latex, centered alignment, table continues on next page, caption
...
```{r plots publication bias/bump in p-values AllP, warning=FALSE, message = FALSE, echo = FALSE, fig.height=8, fig.cap="Histograms with binwidths .01 and .02 of exactly reported p-values in the range [.01-.11] from ‘AllP’. Information is provided for the totals of exactly reported p-values, and for exactly reported p-values (not) related to explicitly stated hypotheses."}
...
```{r plots publication bias/bump in p-values Hyp, warning=FALSE, message = FALSE, echo = FALSE, fig.height=3, fig.cap="Histograms with binwidths .01 (3A) and .02 (3B) of exactly reported p-values related to explicitly stated hypotheses in the range [.01-.11] from 'Hyp'."}
setwd("..") #setting working directory to 'thesis'
setwd("./Data") #setting working directory to 'Data'
...
table7 <- table7 %>%
  #format latex, centered alignment, caption
  kable(booktabs = T, align = "c", caption = "Descriptive statistics on publication bias among reported p-values for ‘AllP’ and ‘Hyp’.", longtable = T) %>% 
...
#Creating Table 8.
table8 <- table8 %>%
  #format html, centered alignment, caption
...
#Creating Table S4.
#h4_table %>%
  #centered alignment, caption, column names
kable(h4_table, format = 'latex', booktabs = T, 
      col.names = c("b", "SE", "p", "z", "OR [95% CI]"),
      align = c("c", "c", "c","c"), 
      caption = "Logistic regression for H4, which concerns the difference in prevalence of marginal significance in results related to hypotheses versus results not related to hypotheses.") %>%   #table will appear in correspondence with its place in this document 
  kable_styling(latex_options = c("HOLD_position"), full_width = F)
```
