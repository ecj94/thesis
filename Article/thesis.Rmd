...
## Data collection^[R code used to create the data sets on results-related topics is available at https://github.com/elisecj94/thesis/tree/development/Code]
...
table2 %>%
  ...
  #adding footnote
  add_footnote("Note. Numbers of articles from which statistical results were used in analyses are shown", notation = "none", escape = F) %>%
