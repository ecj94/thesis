...
#Creating content table cells.
data_table6 <- c("", "", "", "", 
                 29, 168, "22 (13.1%)", "4 (2.4%)", #begin AllP
...
#Reading in file with AllP data.
...
#Only taking into account results with an article number (others are blank rows).
AllP <- subset(Pval_all_jrnl, Article_numb >= 0) 
...
Hyp <- read_excel("/Users/EliseSchramkowski/Documents/Master's thesis/Excel/Hypotheses 07-12-2021.xlsx", col_types = c("numeric", "text", "text", "text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",  "numeric", "numeric", "text", "text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "text", "numeric", "text", "text", "text", "text"))
...
Hyp_all_jrnl_exact <- subset(Hyp, Reported.Comparison == 4)
