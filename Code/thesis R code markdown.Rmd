...
Logistic regression to study the difference in the prevalence of publication bias between results related to explicitly stated hypotheses and results not related to explicitly stated hypotheses for binwidth .01. The prevalence of just significant and just non-significant results does not seem to differ significantly for results related to hypotheses and results not related to hypotheses, b1 = -.132, SE = .504, *p* = .794, OR = .877, 95% CI [.321, 2.345]. Thus, we could not confirm H3a.
...
Logistic regression to study the difference in the prevalence of publication bias between results related to explicitly stated hypotheses and results not related to explicitly stated hypotheses for binwidth .02. There does not seem to be a significant difference in the prevalence of just significant results among results related to hypotheses and results not related to hypotheses, b1 = -.251, SE = .392, *p* = .521, OR = .778, 95% CI [.358, 1.674]. Thus, we could not confirm H3b.
...
Logistic regression to study the difference in the prevalence of marginally significant results between results related to explicitly stated hypotheses and results not related to explicitly stated hypotheses. The prevalence of marginally significant results does not seem to differ significantly for results related to hypotheses and results not related to hypotheses. Thus, we cannot confirm H4, b1 = -0.437, SE = .318, *p* = .170, OR = .646, 95% CI [.342, 1.194].
